# `CMake_jll.jl` (v3.31.5+0)

[![deps](https://juliahub.com/docs/CMake_jll/deps.svg)](https://juliahub.com/ui/Packages/General/CMake_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8d870168bc45f83c5756099345a5f40ac61eb372/C/CMake/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/Kitware/CMake (revision: `9fe70fd76412f41ab2bec24ba42b081b48691961`)
