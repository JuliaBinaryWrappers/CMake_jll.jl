# `CMake_jll.jl` (v3.31.6+0)

[![deps](https://juliahub.com/docs/CMake_jll/deps.svg)](https://juliahub.com/ui/Packages/General/CMake_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c097bbd8e1019a4ef92111358beb8ffa464caf28/C/CMake/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/Kitware/CMake (revision: `859ca5c4d7396a011a462878179bc173e1283731`)
