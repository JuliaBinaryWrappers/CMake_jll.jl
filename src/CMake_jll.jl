...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CMake_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3f4e10e2-61f2-5801-8945-23b9d642d0e6"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CMake", artifacts_toml) for e in artifacts["CMake"]]
...
if best_platform === nothing
    @debug("Unable to load CMake; unsupported platform $(triplet(platform_key_abi()))")
else
